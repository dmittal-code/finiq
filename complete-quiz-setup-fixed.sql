-- Complete Quiz System Setup Script - FIXED VERSION
-- This will clear existing data and set up everything fresh with ALL question options
...
-- ============================================
-- INSERT ALL QUESTION OPTIONS (All 32 questions)
-- ============================================
...
-- Question 22: Financial goals specific
INSERT INTO question_options (question_id, option_text, is_correct, option_order) VALUES
(22, 'True', true, 1),
(22, 'False', false, 2);
...
-- Question 32: Start saving for retirement in 20s
INSERT INTO question_options (question_id, option_text, is_correct, option_order) VALUES
(32, 'True', true, 1),
(32, 'False', false, 2);
...
(4, 1, 6), (4, 11, 7), (4, 21, 8), (4, 26, 9), (4, 31, 10);
...
-- Quiz 6: Investment Strategies (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(6, 9, 1), (6, 10, 2), (6, 6, 3), (6, 3, 4), (6, 7, 5),
(6, 24, 6), (6, 25, 7), (6, 27, 8), (6, 28, 9), (6, 1, 10);

-- Quiz 7: Advanced Credit Management (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(7, 19, 1), (7, 20, 2), (7, 18, 3), (7, 16, 4), (7, 17, 5),
(7, 23, 6), (7, 29, 7), (7, 30, 8), (7, 21, 9), (7, 14, 10);

-- Quiz 8: Financial Planning Essentials (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(8, 24, 1), (8, 25, 2), (8, 23, 3), (8, 22, 4), (8, 21, 5),
(8, 15, 6), (8, 1, 7), (8, 11, 8), (8, 12, 9), (8, 31, 10);

-- Quiz 9: Understanding Economics (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(9, 26, 1), (9, 27, 2), (9, 28, 3), (9, 10, 4), (9, 9, 5),
(9, 24, 6), (9, 1, 7), (9, 2, 8), (9, 25, 9), (9, 7, 10);

-- Quiz 10: Tax Basics and Strategies (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(10, 29, 1), (10, 30, 2), (10, 31, 3), (10, 32, 4), (10, 26, 5),
(10, 14, 6), (10, 23, 7), (10, 21, 8), (10, 11, 9), (10, 1, 10);

-- Quiz 11: Retirement Planning Foundations (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(11, 31, 1), (11, 32, 2), (11, 1, 3), (11, 15, 4), (11, 24, 5),
(11, 23, 6), (11, 26, 7), (11, 29, 8), (11, 30, 9), (11, 14, 10);

-- Quiz 12: Advanced Investment Analysis (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(12, 9, 1), (12, 10, 2), (12, 6, 3), (12, 7, 4), (12, 28, 5),
(12, 27, 6), (12, 25, 7), (12, 24, 8), (12, 3, 9), (12, 5, 10);

-- Quiz 13: Comprehensive Financial Planning (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(13, 23, 1), (13, 24, 2), (13, 25, 3), (13, 29, 4), (13, 30, 5),
(13, 31, 6), (13, 32, 7), (13, 19, 8), (13, 15, 9), (13, 1, 10);

-- Quiz 14: Economic Indicators and Markets (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(14, 27, 1), (14, 28, 2), (14, 26, 3), (14, 10, 4), (14, 9, 5),
(14, 8, 6), (14, 7, 7), (14, 24, 8), (14, 25, 9), (14, 2, 10);

-- Quiz 15: Tax Optimization Strategies (10 questions)
INSERT INTO quiz_questions (quiz_id, question_id, question_order) VALUES
(15, 30, 1), (15, 29, 2), (15, 31, 3), (15, 32, 4), (15, 23, 5),
(15, 24, 6), (15, 25, 7), (15, 1, 8), (15, 15, 9), (15, 26, 10);
