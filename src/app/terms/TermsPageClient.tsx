        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <div className="text-body text-gray-600 mb-10">
              Showing <span className="font-semibold text-blue-600">{filteredTerms.length}</span> of <span className="font-semibold text-gray-800">{financialTerms.length}</span> terms
            </div>
          </div>
            ...
            {filteredTerms.map((term, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <h3 className="text-heading-3 font-bold text-gray-900 group-hover:text-blue-600 transition-colors leading-tight">
                    {term.term}
                  </h3>
                  <span className="px-4 py-2 text-xs font-semibold bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 rounded-full shadow-sm">
                    {term.category}
                  </span>
                </div>
                ...
                <div className="flex items-center text-blue-600 text-body-small font-medium group-hover:text-blue-700 transition-colors">
                  <span>Read more</span>
              ...
              <div className="p-8">
                ...
                <div className="flex items-start justify-between mb-8">
                  <div className="flex-1">
                    ...
                    <span className="px-4 py-2 text-sm font-semibold bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 rounded-full shadow-sm">
                ...
                {selectedTerm.example && (
                  <div className="mb-8">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-l-4 border-blue-400 p-6 rounded-r-xl">
